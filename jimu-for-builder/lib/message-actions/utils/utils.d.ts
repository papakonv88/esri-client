import { MessageCarryData, type MessageType, type MessageJson, type IMWidgetJson, type MessageAction, type MessageActionJson, Immutable, type ImmutableObject, type WidgetJson, type ImmutableArray, type UseDataSource } from 'jimu-core';

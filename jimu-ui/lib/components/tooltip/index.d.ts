 ...
 */
export interface TooltipProps extends Pick<PopperProps, 'placement' | 'modifiers' | 'shiftOptions' | 'offsetOptions' | 'flipOptions'>, Omit<React.HtmlHTMLAttributes<HTMLDivElement>, 'title'> {
    /**

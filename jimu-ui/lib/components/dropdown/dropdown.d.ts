 ...
 */
export interface DropdownProps extends Omit<DropdownContextProps, 'handleOpen' | 'handleClose' | 'referenceWidth' | 'handleMouseEnter' | 'handleMouseLeave' | 'itemRole' | 'toggle'>, Omit<React.HTMLAttributes<HTMLElement>, 'onChange'> {
    /**

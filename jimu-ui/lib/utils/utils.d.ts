import { type IconResult, type IMState, LinkType, type LinkTo, type IMDialogJson, type DuplicateContext, type IMLinkParam, type LinkTarget } from 'jimu-core';
...
export declare const mapLinkParam: (contentMap: DuplicateContext, linkParam: IMLinkParam) => LinkParamInfo;

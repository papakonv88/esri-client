 ...
 * @ignore
 */
export declare function queryValueLabelsByFieldAndPageSize(field: IMFieldSchema, selectedDs: DataSource, pageSize: number, sqlExpression?: SqlExpression, queryScope?: QueryScope, widgetId?: string): Promise<{
    list: CodedValue[];
    recordLength?: number;
}>;
